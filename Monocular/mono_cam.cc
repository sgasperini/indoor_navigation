...
int main(int argc, char **argv) {
	...
	// Capture a new frame and send it to the Monocular SLAM Code for processing
	for(;;){
        ...
        Mat rgbFrame(Size(width, height), CV_8UC3, (void*)color.get_data(), Mat::AUTO_STEP);
		...
		SLAM.TrackMonocular(rgbFrame, tFrame);
