...
FrameDrawer::FrameDrawer(Map* pMap):mpMap(pMap)
{
    ...
    arrow_bg = cv::imread("/Users/Steve/git/indoor_navigation/s_b_arrow_bg.png", CV_LOAD_IMAGE_UNCHANGED);
    cv::cvtColor(arrow_bg, arrow_bg, 1);
    arrow_bg_or = arrow_bg.clone();
